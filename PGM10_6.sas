DATA weight;
INPUT pair low age wt race smoke pre hpten uter;
CARDS;
  1      0     14    135       1        0      0     0     0         
  1      1     14    101       3        1      1     0     0         
  2      0     15     98       2        0      0     0     0         
  2      1     15    115       3        0      0     0     1         
  3      0     16     95       3        0      0     0     0         
  3      1     16    130       3        0      0     0     0         
  4      0     17    103       3        0      0     0     0         
  4      1     17    130       3        1      1     0     1         
  5      0     17    122       1        1      0     0     0         
  5      1     17    110       1        1      0     0     0         
  6      0     17    113       2        0      0     0     0         
  6      1     17    120       1        1      0     0     0         
  7      0     17    113       2        0      0     0     0         
  7      1     17    120       2        0      0     0     0         
  8      0     17    119       3        0      0     0     0         
  8      1     17    142       2        0      0     1     0         
  9      0     18    100       1        1      0     0     0         
  9      1     18    148       3        0      0     0     0         
 10      0     18     90       1        1      0     0     1         
 10      1     18    110       2        1      1     0     0         
 11      0     19    150       3        0      0     0     0         
 11      1     19     91       1        1      1     0     1         
 ...
 33      1     23     94       3        1      0     0     0         
 34      0     24     90       1        1      1     0     0         
...
DATA match_11;
     ...
     status=2-low;
     SELECT(race);
	 WHEN (1) DO; race1=0; race2=0;END;
	 WHEN (2) DO; race1=1; race2=0;END;
         WHEN (3) DO; race1=0; race2=1;END;
     END;

PROC PHREG DATA=match_11;
     MODEL status = wt race1 race2 smoke pre hpten uter;
     STRATA pair;
 RUN;
